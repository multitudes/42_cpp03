...
/*   Updated: 2025/02/19 14:20:34 by lbrusa           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::ClapTrap(void)
  ...
  std::cout << "ClapTrap " << this->name << " has " << this->hitPoints
            << " hitPoints, " << this->energyPoints << " energy points and "
...
void ClapTrap::beRepaired(unsigned int amount) {
  if (this->energyPoints == 0) {
    ...
    std::cout << "ClapTrap " << this->name << " is being repaired for "
              << amount << " points!" << std::endl;
    this->hitPoints += amount;
    this->energyPoints -= 1;
  } else if (this->hitPoints + amount == 10) {
    std::cout << "ClapTrap " << this->name << " has full hitPoints!"
              << std::endl;
    this->hitPoints = 10;
    this->energyPoints -= 1;
  } else if (this->hitPoints + amount > 10) {
    std::cout << "ClapTrap " << this->name
              << " cannot be repaired for more than 10 hitPoints!" << std::endl;
  }
}